...
#define GLFW_GAMEPAD_BUTTON_SHARED          11
#define GLFW_GAMEPAD_BUTTON_DPAD_UP         12
#define GLFW_GAMEPAD_BUTTON_DPAD_RIGHT      13
#define GLFW_GAMEPAD_BUTTON_DPAD_DOWN       14
#define GLFW_GAMEPAD_BUTTON_DPAD_LEFT       15
